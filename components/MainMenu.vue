<template>
  <div class="flex flex-col items-center justify-center h-screen bg-gray-700 px-3 shadow-sm">
    <div class="bg-gray-300 px-3 shadow-lg rounded-lg w-full">
      <div class="text-center mt-8">
        <h1 class="text-4xl font-bold text-gray-800 mb-4">Wanderabout</h1>
        <h2 class="text-1xl font-bold text-gray-800 mb-4">Walkabout Mini Golf Randomizer That Remembers Some Things</h2>
      </div>
      ...
      <div class="flex justify-center items-center mt-8">
        <button
          class="bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 rounded shadow-md"
